    ...
    <form class="book" action="" method="post">
        ...
        <!-- <select type="dropdown" class="form-control" name="approve" required> -->
         ...
         <option disabled selected value>select category</option>
            ...
            <option value="Mathamathics">Mathematics</option>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {                                                                                                                                         
        mysqli_query($db,"INSERT INTO books VALUES ('$_POST[bid]', '$_POST[name]', '$_POST[authors]', '$_POST[status]', '$_POST[quantity]', '$_POST[category]') ;");  // save kar 
        ?>
